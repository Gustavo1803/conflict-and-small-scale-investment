...
*********************************************************************************
* Table F.3 Estimates with Nwighboring Municipalities with Presence ************
*********************************************************************************
  	
// Estimates with dummy FARC
...
eststo: areg `var' treatment1 treatment3 treatment1_ola3 treatment3_ola3 ola3 ola2##c.ln_gastos_t_1 ola2##c.riqueza_pca_1 ola2##c.t_personas_1 ola3##FARC_neigh ///
 if balanced_table==1,  a(consecutivo_c) cl(consecutivo_c)

}
esttab using table_investment_FARC_neigh2.tex, replace label b(2) se(2) parentheses gaps booktabs fragment star(* 0.10 ** 0.05 *** 0.01) r2 ar2
est clear
